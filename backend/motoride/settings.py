...
# Database — uses PostgreSQL when DATABASE_URL env var is set, SQLite otherwise
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        'users.authentication.SilentJWTAuthentication',
    ),
...
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'MotoRide <onboarding@resend.dev>')
